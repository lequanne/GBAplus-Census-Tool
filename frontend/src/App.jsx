  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 12, color: T.muted, marginBottom: 10, lineHeight: 1.55 }}>
        {lang === "fr"
          ? "Téléversez un CSV de vos données de répondants pour comparer la composition réelle de votre sondage aux parts du recensement. Seules les colonnes sélectionnées sont lues — aucune donnée n'est envoyée à un serveur."
          : "Upload a CSV of your respondent data to compare your survey's actual composition against census shares. Only the columns you select are read — no data is sent to a server."}
      </p>
        ...
        <div style={{ marginTop: "1.25rem" }}>
          <div style={{ ...card, borderLeft: `3px solid ${T.green}`, marginBottom: "1rem" }}>
            ...
            <p style={{ fontSize: 12, lineHeight: 1.6, color: T.hint }}>
              {lang === "fr"
                ? "L'IA produit un indice de représentativité (0–100), des constats par groupe avec un niveau de risque, et des recommandations concrètes."
                : "The AI produces a representativeness score (0–100), per-group findings with risk ratings, and concrete recommendations."}
              {csvShares && " " + (lang === "fr" ? "Les données CSV réelles sont incluses dans l'analyse." : "Your actual CSV respondent data is included in the analysis.")}
            </p>
          </div>
